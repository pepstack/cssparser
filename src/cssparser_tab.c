...
#define yyerror         cssprsr_error
#define yydebug         cssprsr_debug
#define yynerrs         cssprsr_nerrs
...
#ifdef CSSPRSR_RBISON_DEBUG
#if CSSPRSR_RBISON_DEBUG
#ifdef YYDEBUG
#undef YYDEBUG
#define YYDEBUG 1
#endif
int yydebug = 1;
#endif // #ifdef CSSPRSR_RBISON_DEBUG
#endif // #ifdef CSSPRSR_RBISON_DEBUG
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined CSSPARSERLTYPE_IS_TRIVIAL && CSSPARSERLTYPE_IS_TRIVIAL \
             && defined CSSPARSERSTYPE_IS_TRIVIAL && CSSPARSERSTYPE_IS_TRIVIAL)))
...
#if CSSPARSERDEBUG || YYERROR_VERBOSE || 1
...
static const char *const yytname[] =
{
  ...
  "CSSPRSR_RCSS_NTH", "CSSPRSR_RCSS_HEX", "CSSPRSR_RCSS_IDSEL", "':'", "'.'",
  "'['", "'*'", "'|'", "CSSPRSR_RCSS_IMPORT_SYM", "CSSPRSR_RCSS_PAGE_SYM",
  ...
  "')'", "']'", "';'", "'('", "','", "'{'", "'+'", "'~'", "'>'", "'/'",
  "'-'", "'='", "'#'", "'%'", "$accept", "stylesheet",
  "cssprsr_internal_rule", "cssprsr_internal_keyframe_rule",
  "cssprsr_internal_keyframe_key_list", "cssprsr_internal_decls",
  "cssprsr_internal_value", "cssprsr_internal_medialist",
  "cssprsr_internal_selector", "space", "maybe_space", "maybe_sgml",
...
# if defined CSSPARSERLTYPE_IS_TRIVIAL && CSSPARSERLTYPE_IS_TRIVIAL
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, void* scanner, struct CssInternalParser * parser)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, void* scanner, struct CssInternalParser * parser)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, void* scanner, struct CssInternalParser * parser)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, void* scanner, struct CssInternalParser * parser)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (scanner);
...
yyreduce:
  ...
  switch (yyn)
    ...
    {
        cssprsr_parse_internal_rule(parser, (yyvsp[-2].rule));
    }
  ...
  case 11:
    ...
    {
        cssprsr_parse_internal_keyframe_rule(parser, (yyvsp[-2].keyframe));
    }
  ...
  case 12:
    ...
    {
        cssprsr_parse_internal_keyframe_key_list(parser, (yyvsp[-1].valueList));
    }
  ...
  case 13:
    ...
    {
        /* can be empty */
        cssprsr_parse_internal_declaration_list(parser, (yyvsp[-1].boolean));
    }
  ...
  case 14:
    ...
    {
        cssprsr_parse_internal_value(parser, (yyvsp[-1].valueList));
    }
  ...
  case 15:
    ...
    {
        cssprsr_parse_internal_media_list(parser, (yyvsp[-1].mediaList));
    }
  ...
  case 16:
    ...
    {
        cssprsr_parse_internal_selector(parser, (yyvsp[-1].selectorList));
    }
  ...
  case 33:

    {
        ...
        cssprsr_set_charset(parser, &(yyvsp[-2].string));
    }
  ...
  case 36:
    ...
    {
        if ((yyvsp[-1].rule))
            cssprsr_add_rule(parser, (yyvsp[-1].rule));
    }
  ...
  case 45:

    {
        ...
        cssprsr_end_rule(parser, !!(yyval.rule));
    }
  ...
  case 50:
    ...
    {
      (yyval.ruleList) = cssprsr_rule_list_add(parser, (yyvsp[-1].rule), (yyvsp[-2].ruleList));
    }
  ...
  case 60:
    ...
    {
        cssprsr_start_rule_header(parser, CssRuleImport);
    }
  ...
  case 61:
    ...
    {
        cssprsr_end_rule_header(parser);
        cssprsr_start_rule_body(parser);
    }
  ...
  case 62:
    ...
    {
        (yyval.rule) = cssprsr_new_import_rule(parser, &(yyvsp[-4].string), (yyvsp[-1].mediaList));
    }
  ...
  case 64:
    ...
    {
        cssprsr_add_namespace(parser, &(yyvsp[-3].string), &(yyvsp[-2].string));
        (yyval.rule) = 0;
    }
  ...
  case 71:
    ...
    {
        cssprsr_string_to_lowercase(parser, &(yyvsp[-3].string));
        (yyval.mediaQueryExp) = cssprsr_new_media_query_exp(parser, &(yyvsp[-3].string), (yyvsp[-1].valueList));
  ...
  case 73:
    ...
    {
        (yyval.mediaQueryExpList) = cssprsr_new_media_query_exp_list(parser);
        cssprsr_media_query_exp_list_add(parser, (yyvsp[0].mediaQueryExp), (yyval.mediaQueryExpList));   
    }
  ...
  case 81:
    ...
    {
        cssprsr_string_to_lowercase(parser, &(yyvsp[-1].string));
        (yyval.mediaQuery) = cssprsr_new_media_query(parser, (yyvsp[-2].mediaQueryRestrictor), &(yyvsp[-1].string), (yyvsp[0].mediaQueryExpList));
    }
  ...
  case 85:
    ...
    {
        (yyval.mediaList) = cssprsr_new_media_list(parser);
    }
  ...
  case 87:
    ...
    {
        (yyval.mediaList) = cssprsr_new_media_list(parser);
        cssprsr_media_list_add(parser, (yyvsp[0].mediaQuery), (yyval.mediaList));
    }
  ...
  case 89:

    {
        ...
        cssprsr_parser_log(parser, "createFloatingNotAllQuery");
    }
  ...
  case 90:
    ...
    {
        (yyval.mediaList) = cssprsr_new_media_list(parser);
        cssprsr_media_list_add(parser, (yyvsp[-3].mediaQuery), (yyval.mediaList));
    }
  ...
  case 93:
    ...
    {
        cssprsr_start_rule_header(parser, CssRuleMedia);
    }
  ...
  case 96:
    ...
    {
        (yyval.rule) = cssprsr_new_media_rule(parser, (yyvsp[-6].mediaList), (yyvsp[-1].ruleList));
    }
  ...
  case 112:
    ...
    {
        // cssprsr_parser_report_error(parser, $3, InvalidSupportsConditionCSSError);
        // $$ = false;
    }
  ...
  case 115:
    ...
    {
        cssprsr_start_rule_header(parser, CssRuleKeyframes);
    }
  ...
  case 117:
    ...
    {
        (yyval.rule) = cssprsr_new_keyframes_rule(parser, &(yyvsp[-7].string), (yyvsp[-1].keyframeRuleList), (yyvsp[-8].boolean));
    }
  ...
  case 122:
    ...
    {
        (yyval.keyframeRuleList) = cssprsr_new_Keyframe_list(parser);
  ...
  case 123:

    {
        ...
        cssprsr_keyframe_rule_list_add(parser, (yyvsp[-2].keyframe), (yyval.keyframeRuleList));
    }
  ...
  case 125:
    ...
    {
        (yyval.keyframe) = cssprsr_new_keyframe(parser, (yyvsp[-4].valueList));
    }
  ...
  case 126:
    ...
    {
        (yyval.valueList) = cssprsr_new_value_list(parser);
        cssprsr_value_list_add(parser, (yyvsp[-1].value), (yyval.valueList));
    }
  ...
  case 130:
    ...
    {
        // cssprsr_parser_report_error(parser, parser->lastLocationLabel(), InvalidKeyframeSelectorCSSError);
        cssprsr_parser_clear_declarations(parser);
        cssprsr_parser_reset_declarations(parser);
        cssprsr_parser_report_error(parser, NULL, "InvalidKeyframeSelectorCSSError");
    }
  ...
  case 131:
    ...
    {
        cssprsr_start_rule_header(parser, CssRuleFontFace);
    }
  ...
  case 132:
    ...
    {
        (yyval.rule) = cssprsr_new_font_face(parser);
    }
  ...
  case 141:
    ...
    {
        cssprsr_start_declaration(parser);
    }
  ...
  case 142:
    ...
    {
        cssprsr_start_rule_header(parser, CssRuleStyle);
        cssprsr_start_selector(parser);
    }
  ...
  case 145:
    ...
    {
        (yyval.rule) = cssprsr_new_style_rule(parser, (yyvsp[-7].selectorList));
    }
  ...
  case 147:
    ...
    {
        (yyval.selectorList) = cssprsr_reusable_selector_list(parser);
        cssprsr_selector_list_shink(parser, 0, (yyval.selectorList));
        cssprsr_selector_list_add(parser, cssprsr_sink_floating_selector(parser, (yyvsp[0].selector)), (yyval.selectorList));
    }
  ...
  case 153:
    ...
    { 
        cssprsr_string_clear(parser, &(yyval.string));
    }
  ...
  case 154:
    ...
    {
        (yyval.string) = cssAsteriskString;
    }
  ...
  case 157:
    ...
    {
        (yyval.selector) = cssprsr_rewrite_specifier_with_element_name(parser, &(yyvsp[-1].string), (yyvsp[0].selector));
        if (!(yyval.selector))
            YYERROR;
    }
  ...
  case 158:
    ...
    {
        (yyval.selector) = cssprsr_rewrite_specifier_with_namespace_if_needed(parser, (yyvsp[0].selector));
        if (!(yyval.selector))
            YYERROR;
    }
  ...
  case 165:
    ...
    {
        (yyval.selector) = cssprsr_rewrite_specifiers(parser, (yyvsp[-1].selector), (yyvsp[0].selector));
    }
  ...
  case 189:

    {
        ...
        // if ($$->pseudo == CssSelectorPseudoUnknown) {
        //     cssprsr_parser_report_error(parser, $2, InvalidSelectorPseudoCSSError);
        //     YYERROR;
    }
  ...
  case 190:

    {
        ...
        //     cssprsr_parser_report_error(parser, $3, InvalidSelectorPseudoCSSError);
        //     YYERROR;
    }
  ...
  case 196:
    ...
    {
        if (!cssprsr_selector_is_simple(parser, (yyvsp[-2].selector)))
            YYERROR;
        else {
            (yyval.selector) = cssprsr_new_selector(parser);
            (yyval.selector)->match = CssSelMatchPseudoClass;
            ...
            cssprsr_selector_list_add(parser, cssprsr_sink_floating_selector(parser, (yyvsp[-2].selector)), array);
            cssprsr_adopt_selector_list(parser, array, (yyval.selector));
  ...
  case 207:

    {
        ...
        (yyval.boolean) = cssprsr_new_declaration(parser, &(yyvsp[-5].string), (yyvsp[0].boolean), (yyvsp[-1].valueList));
        if (!(yyval.boolean)) {
            // parser->rollbackLastProperties(parser->m_parsedProperties.size() - oldParsedProperties);
            cssprsr_parser_report_error(parser, (yyvsp[-2].location), "InvalidPropertyValueCSSError");
        } else {
            isPropertyParsed = true;
        }
        cssprsr_end_declaration(parser, (yyvsp[0].boolean), isPropertyParsed);
    }
  ...
  case 208:

    {
        ...
        cssprsr_parser_report_error(parser, (yyvsp[-4].location), "InvalidPropertyValueCSSError");
        cssprsr_end_declaration(parser, false, false);
        (yyval.boolean) = false;
    }
  ...
  case 210:
    ...
    {
        cssprsr_parser_report_error(parser, (yyvsp[-1].location), "PropertyDeclarationCSSError");
        cssprsr_end_declaration(parser, false, false);
        (yyval.boolean) = false;
    }
  ...
  case 212:

    {
        ...
        //     cssprsr_parser_report_error(parser, $1, InvalidPropertyCSSError);
        (yyval.string) = (yyvsp[-1].string);
        cssprsr_set_current_declaration(parser, &(yyval.string));
    }
  ...
  case 215:
    ...
    {
        (yyval.valueList) = cssprsr_new_value_list(parser);
        cssprsr_value_list_add(parser, cssprsr_new_ident_value(parser, &(yyvsp[-1].string)), (yyval.valueList));
    }
  ...
  case 217:
    ...
    {
        (yyval.value) = cssprsr_new_list_value(parser, NULL);
    }
  ...
  case 218:
    ...
    {
        (yyval.value) = cssprsr_new_list_value(parser, (yyvsp[-1].valueList));
    }
  ...
  case 220:
    ...
    {
        (yyval.valueList) = cssprsr_new_value_list(parser);
        cssprsr_value_list_add(parser, (yyvsp[0].value), (yyval.valueList));
    }
  ...
  case 221:
    ...
    {
        (yyval.valueList) = (yyvsp[-2].valueList);
        cssprsr_value_list_add(parser, cssprsr_new_operator_value(parser, (yyvsp[-1].character)), (yyval.valueList));
        cssprsr_value_list_add(parser, (yyvsp[0].value), (yyval.valueList));
    }
  ...
  case 228:

    {
      ...
      // $$->fValue *= $1;
      cssprsr_value_set_sign(parser, (yyval.value), (yyvsp[-2].integer));
  ...
  case 230:
    ...
    { (yyval.value) = cssprsr_new_ident_value(parser, &(yyvsp[-1].string)); }
  ...
  case 236:
    ...
    { (yyval.value) = cssprsr_new_value(parser); (yyval.value)->id = CssValueInvalid; 
    //(yyval.value)->string = "#"; 
  ...
  case 239:
    ...
    { /* Handle width: %; */ (yyval.value) = cssprsr_new_value(parser); (yyval.value)->id = CssValueInvalid; (yyval.value)->isInt = false; (yyval.value)->unit = 0; }
  ...
  case 271:
    ...
    {
        (yyval.value) = cssprsr_new_function_value(parser, &(yyvsp[-3].string), (yyvsp[-1].valueList));
    }
  ...
  case 272:
    ...
    {
        (yyval.value) = cssprsr_new_function_value(parser, &(yyvsp[-2].string), NULL);
    }
  ...
  case 282:
    ...
    {
        (yyval.valueList) = (yyvsp[-2].valueList);
        cssprsr_value_list_insert(parser, cssprsr_new_operator_value(parser, '('), 0, (yyval.valueList));
        cssprsr_new_operator_value(parser, ')');
        cssprsr_value_list_add(parser, cssprsr_new_operator_value(parser, ')'), (yyval.valueList));
    }
  ...
  case 286:

    {
        (yyval.valueList) = (yyvsp[-2].valueList);
        cssprsr_value_list_add(parser, cssprsr_new_operator_value(parser, (yyvsp[-1].character)), (yyval.valueList));
        cssprsr_value_list_steal_values(parser, (yyvsp[0].valueList), (yyval.valueList));
    }
  ...
  case 288:
    ...
    {
        (yyval.value) = cssprsr_new_function_value(parser, &(yyvsp[-4].string), (yyvsp[-2].valueList));
    }
  ...
  case 292:
    ...
    {
        cssprsr_parser_report_error(parser, (yyvsp[-1].location), "InvalidRuleCSSError");
    }
  ...
  case 297:
    ...
    {
        // cssprsr_parser_report_error(parser, $4, InvalidSupportsConditionCSSError);
  ...
  case 299:
    ...
    {
        // cssprsr_parser_resume_error_logging();
        // cssprsr_parser_report_error(parser, $1, "InvalidRuleCSSError regular_invalid_at_rule_header");
    }
  ...
  case 300:
    ...
    {
        cssprsr_parser_report_error(parser, (yyvsp[-3].location), "InvalidRuleCSSError invalid_rule");
    }
  ...
  case 304:
    ...
    {
        cssprsr_parser_report_error(parser, (yyvsp[-2].location), "InvalidRuleCSSError invalid_rule_header");
    }
  ...
  case 307:
    ...
    {
        cssprsr_end_invalid_rule_header(parser);
   }
  ...
  case 308:
    ...
    {
        cssprsr_parser_report_error(parser, parser->position, "invalidBlockHit");
    }
  ...
  case 313:
    ...
    {
        (yyval.location) = cssprsr_parser_current_location(parser, &yylloc);
    }
